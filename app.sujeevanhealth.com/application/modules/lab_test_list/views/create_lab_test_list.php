                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> 
                            <div class="form-group">
                                ...
                                <input name="lab_test_listnametype" type="text" class="form-control lab_test_listnametype" placeholder="Enter Lab Test List Name" required="" autocomplete="off" value="<?php echo set_value("lab_test_listnametype");?>"/>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> 
                            <div class="form-group">
                                ...
                                <input name="lab_test_price" type="number" step="0.01" class="form-control lab_test_price" placeholder="Enter Lab Test Price" required="" autocomplete="off" value="<?php echo set_value("lab_test_price");?>"/>
