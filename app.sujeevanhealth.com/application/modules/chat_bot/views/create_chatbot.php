                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-control healthcategory" onchange="updaatehealthcategory()"  name="healthcategory">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-control healthcategorysub" name="healthcategorysub">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Order" required="" name="consult_order" value="<?php echo set_value('consult_order');?>"/>
