    ...
    <table class="table table-striped table-hover js-basic-example tablehrcover" id="myTable">
        <thead>
            <tr id="filters">
                ...
                <th><a href="javascript:void(0);" data-type="order" data-field="regvendor_mobile" urlvalue="<?php echo $urlvalue;?>" onclick="getdatafiled($(this))">Mobile <i class="fa font-14 fa-sort-up pull-right"></i></a> </th>
                <th><a href="javascript:void(0);" data-type="order" data-field="regvendor_email_id" urlvalue="<?php echo $urlvalue;?>" onclick="getdatafiled($(this))">Email <i class="fa font-14 fa-sort-up pull-right"></i></a> </th>
                ...
                <th><a href="javascript:void(0);" data-type="order" data-field="regvendor_age" urlvalue="<?php echo $urlvalue;?>" onclick="getdatafiled($(this))">Age <i class="fa font-14 fa-sort-up pull-right"></i></a> </th>
                <th><a href="javascript:void(0);" data-type="order" data-field="district_name" urlvalue="<?php echo $urlvalue;?>" onclick="getdatafiled($(this))">City <i class="fa font-14 fa-sort-up pull-right"></i></a> </th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $ve["regvendor_mobile"];?></td>
                <td><?php echo $ve["regvendor_email_id"];?></td>
                <td><?php echo $ve["specialization_name"];?></td>
                <td><?php echo $ve["regvendor_age"];?></td>
                <td><?php echo $ve["district_name"];?></td>
