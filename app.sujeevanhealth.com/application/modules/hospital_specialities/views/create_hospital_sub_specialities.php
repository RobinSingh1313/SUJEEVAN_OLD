                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select title="Select Module" class="form-control select2" name="hospital_specialities_id">
                                    ...
                                    if(count($specialities) > 0) {
                                        ...
                                        ?>
                                        <option  value="<?php echo $s['hospital_specialities_id'];?>" ><?php echo $s['hospital_specialities_name'];?></option>
                                        <?php
                                        }
                                    }
                                    ?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> 
                            <div class="form-group">
                                ...
                                <input name="hospital_sub_specialitiesnametype" type="text" class="form-control hospital_sub_specialitiesnametype" placeholder="Enter Hospital Sub Speciality Name" required="" autocomplete="off" value="<?php echo set_value("hospital_sub_specialitiesnametype");?>"/>
