                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> 
                            <div class="form-group">
                                ...
                                <input name="hospital_specialitiesnametype" type="text" class="form-control hospital_specialitiesnametype" placeholder="Enter Hospital Speciality Name" required="" autocomplete="off" value="<?php echo set_value("hospital_specialitiesnametype");?>"/>
