                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> 
                            <div class="form-group">
                                ...
                                <input name="hospital_facilitiesnametype" type="text" class="form-control hospital_facilitiesnametype" placeholder="Enter Hospital Facility Name" required="" autocomplete="off" value="<?php echo set_value("hospital_facilitiesnametype");?>"/>
